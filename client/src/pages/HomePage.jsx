          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            ...
            >
              ...
              <p className="text-lg leading-relaxed text-gray-600">
                For over five decades, PharmaCare has been at the forefront of
        ...
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-xl text-gray-600">
              From cardiovascular care to oncology, we offer a wide range of
      ...
      <section className="bg-white py-20">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-xl text-gray-600">
              Our commitment to excellence sets us apart in the pharmaceutical
              industry.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="mx-auto mb-8 max-w-2xl text-xl text-blue-100">
                Get in touch with our team to learn more about our products and
                services.
              </p>
              <Link
                to="/contact"
